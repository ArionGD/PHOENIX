...
def dashboard(request):
    ...
    mmi_data = cache.get('tickertape_mmi_full')
    if not mmi_data:
        try:
            ...
            mmi_data = raw_data['data']
            cache.set('tickertape_mmi_full', mmi_data, 600)
        except Exception:
            mmi_data = None
    ...
    context = {
        ...
        'mmi_data': mmi_data,
        'mmi_value': mmi_data['currentValue'] if mmi_data else 50.0,
    }
